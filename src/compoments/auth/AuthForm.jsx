  ...
  return (
    <div> 
      <form className="w-full  py-20 px-10 flex flex-col">
        ...
        <input type="text" placeholder={" Nom d'utilisateur"} className="w-full text-[1.2rem] outline-none p-3 border-b-2 border-[#f0f2f5]"/>

        <input type="text" placeholder={" Mot de passe"} className="w-full text-[1.2rem] outline-none p-3 border-b-2 border-[#f0f2f5]"/>

        <input type="text" placeholder={" Confirmer votre mot de passe"} className="w-full text-[1.2rem] outline-none p-3 border-b-2 border-[#f0f2f5]"/>
         ...
         Vous navez pas un compte {''}
          ...
          <button className=' text-[1.2rem] mt-5 py-2 px-3 bg-[#00a884] text-white'>Inscription</button>
      </form>
    </div>
  )
}
